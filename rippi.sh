...
while getopts "hed" opt; do
	case $opt in
	h)
		echo "\033[35;1m﬙ RunIPPInterpret \033[37;3m(by Onegen)\033[0m"
		...
		echo "    \033[32m-e\033[0m     \033[30mPrádzny vstup (inak bude interprét očakávať vstup na stdin)\033[0m"
		echo "    \033[32m-d\033[0m     \033[30mRozšírený výstup interpréta (debug mode)\033[0m"
		exit 0
		;;
	e)
		iin="/dev/null"
...
echo "\033[35;1m﬙ IPPI Runner \033[37;3m(by Onegen)\033[0m"
